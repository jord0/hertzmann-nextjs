...
interface PhotographsPageInnerProps {
  photographers: BrowsePhotographer[];
  keywords: string[];
}

function PhotographsPageInnerContent({ photographers, keywords }: PhotographsPageInnerProps) {
...
export default function PhotographsPageInner(props: PhotographsPageInnerProps) {
  return (
    <Suspense>
